  ...
  faqs: [
    {
      ...
      answer: "Syarat utama sewa mobil antara lain: KTP asli, SIM A yang masih aktif, Kartu Keluarga (KK), dan bukti pembayaran tagihan listrik/PBB atau kartu identitas karyawan."
    },
    {
      id: 2,
